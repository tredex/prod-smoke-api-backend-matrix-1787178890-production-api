...
```bash
docker build -t tredex/prod-smoke-api-backend-matrix-1787178890-production-api .
docker run -p 3000:3000 tredex/prod-smoke-api-backend-matrix-1787178890-production-api
```
